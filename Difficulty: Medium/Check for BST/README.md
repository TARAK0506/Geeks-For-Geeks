<h2><a href="https://www.geeksforgeeks.org/problems/check-for-bst/1?page=1&category=Tree&difficulty=Medium,Hard&sortBy=difficulty">Check for BST</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><div>
